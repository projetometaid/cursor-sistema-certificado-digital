PSBio Local
Este método verifica através do CPF informado se o titular possui biometria cadastrada no PSBio Safeweb.

POST https://pss.safewebpss.com.br/Service/Microservice/Shared/Partner/api/psbio/consulta/biometria/local
Exemplos de uso
C#
Node
    ...
    url: 'https://pss.safewebpss.com.br/Service/Microservice/Shared/Partner/api/psbio/consulta/biometria/local',
