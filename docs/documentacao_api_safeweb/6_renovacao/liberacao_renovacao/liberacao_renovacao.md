Liberação Renovação
Este Serviço atualiza a flag de liberado na solicitação, flag utilzada para validar se há pagamento no momento da renovação.

Atenção! Apenas para solicitações e-CPF/e-CNPJ Modelo A3 com produto cujo Tipo de Emissão
seja Renovação On-line e a solicitação de renovação já exista.
