...
POST https://pss.safewebpss.com.br/Service/Microservice/Shared/Partner/api/Add/1
Exemplos de uso
C#
Node
    var request = require("request");
    var options = { method: 'POST',
    url: 'https://pss.safewebpss.com.br/Service/Microservice/Shared/Partner/api/Add/1',
...
#	NomeFantasia	String	Nome fantasia da empresa.	N
...
#	CEI	String	Número CEI do responsável.	N
