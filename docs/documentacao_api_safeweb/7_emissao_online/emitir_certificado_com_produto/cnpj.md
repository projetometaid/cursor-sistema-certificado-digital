Emitir Certificado com Produto
Este Serviço retorna os dados da emissão do certificado a ser emitido, validando o id do Produto informado.

GET https://pss.safewebpss.com.br/Service/Microservice/Shared/Partner/api/EmitirCertificadoOnline/{numeroSerie}/{idProduto}/{cnpjAr}
Exemplos de uso
C#
Node
    ...
    url: 'https://pss.safewebpss.com.br/Service/Microservice/Shared/Partner/api/EmitirCertificadoOnline/{numeroSerie}/{idProduto}/{cnpjAr}',
